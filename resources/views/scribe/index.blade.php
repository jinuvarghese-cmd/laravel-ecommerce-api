    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-logout">Logout the user</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="orders">
                    <a href="#orders">Orders</a>
                                ...
                                <a href="#orders-POSTapi-orders">Place a new order</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="orders-GETapi-orders">
                                <a href="#orders-GETapi-orders">Get orders of the logged-in user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="orders-GETapi-admin-orders">
                                <a href="#orders-GETapi-admin-orders">Get all orders (admin only)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="products">
                    <a href="#products">Products</a>
                                ...
                                <a href="#products-POSTapi-products">Add a new product (admin only)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-PUTapi-products--id-">
                                <a href="#products-PUTapi-products--id-">Update a product (admin only)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="products-DELETEapi-products--id-">
                                <a href="#products-DELETEapi-products--id-">Delete a product (admin only)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="webhooks">
                    <a href="#webhooks">Webhooks</a>
                                    ...
                                    <ul id="tocify-subheader-webhooks" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="webhooks-POSTapi-webhooks-payment">
                                <a href="#webhooks-POSTapi-webhooks-payment">Handle payment gateway webhook</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Confirmed password. Example: <code>password123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>optional Role of the user. Allowed values: &quot;user&quot;, &quot;admin&quot;. Defaults to &quot;user&quot;. Example: <code>user</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-logout">Logout the user</h2>
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="orders">Orders</h1>
                                ...
                                <h2 id="orders-POSTapi-orders">Place a new order</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Place a new order with a list of products and quantities.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Quantity of the product. Example: <code>2</code></p>
                    </div>
                                    </details>
        </div>
        </form>

                    <h2 id="orders-GETapi-orders">Get orders of the logged-in user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Fetch all orders placed by the currently authenticated user.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="orders-GETapi-admin-orders">Get all orders (admin only)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retrieve all orders placed by all users. Only accessible to admin users.</p>
...
<p>Returns a list of all available products with basic details.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="products-POSTapi-products">Add a new product (admin only)</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Name of the product. Example: <code>Laptop</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value="Fast gaming laptop"
               data-component="body">
    <br>
<p>Description of the product. Example: <code>Fast gaming laptop</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Price of the product. Example: <code>999.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Stock quantity. Example: <code>10</code></p>
                    ...
                    <h2 id="products-PUTapi-products--id-">Update a product (admin only)</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Name of the product. Example: <code>Laptop Pro</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value="Updated fast gaming laptop"
               data-component="body">
    <br>
<p>Description of the product. Example: <code>Updated fast gaming laptop</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>price</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Price of the product. Example: <code>1299.99</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>stock</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Stock quantity. Example: <code>5</code></p>
        </div>
        </form>

                    <h2 id="products-DELETEapi-products--id-">Delete a product (admin only)</h2>
...
<p>The ID of the product. Example: <code>1</code></p>
    ...
    <p>This endpoint receives payment notifications from a payment gateway.
It verifies and processes the incoming payment data (e.g. marking an order as paid).</p>

                                <h2 id="webhooks-POSTapi-webhooks-payment">Handle payment gateway webhook</h2>
...
<span id="example-requests-POSTapi-webhooks-payment">
<blockquote>Example request:</blockquote>
...
<div class="bash-example">
    ...
    \"payment_reference_id\": \"txn_8jdfg9sdfg\",
    \"paid_at\": \"2025-05-24T14:52:00Z\"
}"
</code></pre></div>
...
<span id="example-responses-POSTapi-webhooks-payment">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-webhooks-payment" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-webhooks-payment"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-webhooks-payment"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-webhooks-payment" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-webhooks-payment">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-webhooks-payment" data-method="POST"
      data-path="api/webhooks/payment"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-webhooks-payment', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-webhooks-payment"
                    onclick="tryItOut('POSTapi-webhooks-payment');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-webhooks-payment"
                    onclick="cancelTryOut('POSTapi-webhooks-payment');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-webhooks-payment"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/webhooks/payment</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-webhooks-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-webhooks-payment"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="order_id"                data-endpoint="POSTapi-webhooks-payment"
               value="5"
               data-component="body">
    <br>
<p>ID of the order being paid. Example: <code>5</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="payment_status"                data-endpoint="POSTapi-webhooks-payment"
               value="success"
               data-component="body">
    <br>
<p>Status of the payment. Example: <code>success</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>payment_reference_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="payment_reference_id"                data-endpoint="POSTapi-webhooks-payment"
               value="txn_8jdfg9sdfg"
               data-component="body">
    <br>
<p>The payment reference from the gateway. Example: <code>txn_8jdfg9sdfg</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="paid_at"                data-endpoint="POSTapi-webhooks-payment"
               value="2025-05-24T14:52:00Z"
               data-component="body">
    <br>
<p>The timestamp when the payment was made. Must be a valid date. Example: <code>2025-05-24T14:52:00Z</code></p>
        </div>
        </form>
